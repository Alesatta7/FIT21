...
public class Difficile extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent ritornoHome = new Intent(Difficile.this, Home.class);
        ...
        esercizi.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Difficile.this,ListaEsercizi.class);
        ...
        allenamento.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Difficile.this,SceltaAllenamento.class);
                startActivity(intent);
            }
        });
