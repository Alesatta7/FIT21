...
public class Facile extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent ritornoHome = new Intent(Facile.this, Home.class);
        ...
        polpacci.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(i[3] == 1){
                    salti.setVisibility(View.GONE);
                    i[3]=0;
                }
                else if(i[3] == 0){
                    salti.setVisibility(View.VISIBLE);
                    i[3]=1;
                }
            }
        });
        ...
        tricipiti.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(i[8] == 1){
                    ...
                    piegamenti.setVisibility(View.GONE);
                    i[8]=0;
                }
                else if(i[8] == 0){
                    piegamentiFianco.setVisibility(View.VISIBLE);
                    piegamenti.setVisibility(View.VISIBLE);
                    i[8]=1;
                }
            }
        });
        ...
        esercizi.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Facile.this,ListaEsercizi.class);
        ...
        allenamento.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Facile.this,SceltaAllenamento.class);
                startActivity(intent);
            }
        });
        ...
        crunch.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                es = 0;
                Intent cambioP = new Intent(Facile.this, Tutorial.class);
